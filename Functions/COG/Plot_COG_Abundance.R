...
heatmap.2(cog3,col=bluered, labRow=row.names(cog),trace="none", scale="none", key=T,keysize=1.0,cexCol=1.2,cexRow=0.5, xlab="Function Class", srtRow=45, adjRow=c(0, 1))
dev.off()
